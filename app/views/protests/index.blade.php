    ...
    <div class="col-md-8" ng-app="protestApp" ng-controller="protestsController">
      <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active">
          <a href="#global" aria-controls="global" role="tab" data-toggle="tab">Global Protests</a>
        </li>
        <li role="presentation">
          <a href="#local" aria-controls="local" role="tab" data-toggle="tab">Nearby Protests</a>
        </li>
      </ul>
